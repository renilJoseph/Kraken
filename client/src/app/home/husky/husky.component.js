...
var HuskyComponent = /** @class */ (function () {
    function HuskyComponent(userService, rosService, hideservice, modal) {
    ...
    HuskyComponent.prototype.ngDoCheck = function () {
    ...
    HuskyComponent.prototype.onWindowResize = function () {
        var _this = this;
    ...
    HuskyComponent.prototype.resizeViewer = function (widthMultiplier) {
    ...
    HuskyComponent.prototype.ngOnInit = function () {
        this.loadAllUsers();
    ...
    HuskyComponent.prototype.deleteUser = function (_id) {
        var _this = this;
        this.userService.delete(_id).subscribe(function () { _this.loadAllUsers(); });
    };
    HuskyComponent.prototype.loadAllUsers = function () {
        var _this = this;
        this.userService.getAll().subscribe(function (users) { _this.users = users; });
    };
    HuskyComponent.prototype.resizeWindow = function (input) {
    ...
    HuskyComponent.prototype.resizeBox = function () {
        var _this = this;
    ...
    HuskyComponent.prototype.changeTopic = function (topicName) {
    ...
    HuskyComponent.prototype.topicBox = function () {
        var _this = this;
        var dialogRef = this.modal.prompt()
            .size('lg')
            .isBlocking(true)
    ...
    HuskyComponent.prototype.modulo = function (a, b) {
        return a - Math.floor(a / b) * b;
    };
    HuskyComponent.prototype.ToUint32 = function (x) {
        return this.modulo(this.ToInteger(x), Math.pow(2, 32));
    };
    HuskyComponent.prototype.ToInteger = function (x) {
        x = Number(x);
    ...
    ], HuskyComponent.prototype, "TLM", void 0);
    __decorate([
        core_1.HostListener('window:resize'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], HuskyComponent.prototype, "onWindowResize", null);
    HuskyComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
