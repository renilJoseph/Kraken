...
var DeleteUsersComponent = /** @class */ (function () {
    function DeleteUsersComponent(router, userService) {
        this.router = router;
    ...
    DeleteUsersComponent.prototype.deleteUser = function (_id) {
        var _this = this;
        this.userService.delete(_id).subscribe(function () { _this.loadAllUsers(); });
    };
    DeleteUsersComponent.prototype.loadAllUsers = function () {
        var _this = this;
...
exports.DeleteUsersComponent = DeleteUsersComponent;
//# sourceMappingURL=delete-users.component.js.map