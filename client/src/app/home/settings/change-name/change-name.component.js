...
var ChangeNameComponent = /** @class */ (function () {
    function ChangeNameComponent(userService, alertService, router) {
    ...
    ChangeNameComponent.prototype.changeName = function () {
        var _this = this;
        this.loading = true;
        this.userService.update(this.model)
            .subscribe(function (data) {
            _this.alertService.success('Name change successful.', true);
