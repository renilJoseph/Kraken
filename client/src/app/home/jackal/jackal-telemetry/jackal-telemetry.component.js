...
var JackalTelemetryComponent = /** @class */ (function () {
    function JackalTelemetryComponent(rosService) {
        this.rosService = rosService;
    }
    JackalTelemetryComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    JackalTelemetryComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return JackalTelemetryComponent;
}());
exports.JackalTelemetryComponent = JackalTelemetryComponent;
//# sourceMappingURL=jackal-telemetry.component.js.map